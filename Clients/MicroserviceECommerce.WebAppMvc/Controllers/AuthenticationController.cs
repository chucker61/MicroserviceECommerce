...
namespace MicroserviceECommerce.WebAppMvc.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        public async Task<ActionResult> LogOut(string returnUrl)
        {
            ...
            var properties = new AuthenticationProperties(new Dictionary<string, string?>
            {
                [OpenIddictClientAspNetCoreConstants.Properties.Issuer] = "https://localhost:7144",
        ...
        public async Task<IActionResult> Refresh()
        {
            ...
            RefreshTokenRequest refreshTokenRequest = new RefreshTokenRequest()
            {
                ...
                Address = (await httpClient.GetDiscoveryDocumentAsync("https://localhost:7144")).TokenEndpoint
            };
