using MicroserviceECommerce.WebAppMvc.Models;
...
namespace MicroserviceECommerce.WebAppMvc.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index(string button, CancellationToken cancellationToken)
        {
            ...
            using HttpRequestMessage httpRequestMessage = new(button == "GET" ? HttpMethod.Get : HttpMethod.Post, "https://localhost:7252/api/category");
